...
class AccountSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $accounts = [
            ...
            ['name' => 'FAUZANA FIKRI', 'nisn' => '0081299921', 'jurusan' => 'RPL', 'jenis_kelamin' => 'Perempuan', 'status' => 'nonaktif'],
            ['name' => 'KHAFIYAN NURUL HAKIM', 'nisn' => '0077650865', 'jurusan' => 'RPL', 'jenis_kelamin' => 'Laki-laki', 'status' => 'nonaktif'],
            ['name' => 'LUKMANUL HAKIM', 'nisn' => '0081674328', 'jurusan' => 'RPL', 'jenis_kelamin' => 'Laki-laki', 'status' => 'nonaktif'],
            ...
            ['name' => 'YULIANI', 'nisn' => '0081674328', 'jurusan' => 'RPL', 'jenis_kelamin' => 'Perempuan', 'status' => 'nonaktif'],
        ];
